...
\newcommand{\nombre}{Daniel Santidrián Alonso} %%% cambio de comando
...
\noindent Que el alumno D. \nombre, con DNI 71310411S, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado UBUassistant. 
...
With these premises UBUassistant is born, a virtual assistant that is able to recognize a text entry by a user and granting a response to that entry. This way a user can interact with an assistant to find a section of the web inestead of naviganting among menus that may be ambiguous.

Specifically, UBUassistant is able to guide a user of the website of the University of Burgos without having to navigate through the web, if there is a specific response, it will be shown immediately, otherwise the web adress where the response is located will be given. Just ask the assistant about some section of the website.
\end{abstract}
